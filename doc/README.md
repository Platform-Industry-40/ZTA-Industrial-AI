...
The complete project documentation is located in the `/doc` folder and is maintained bilingually (German + English).

## Current Documentation Structure (as of March 07, 2026)
...
│   ├── 07 Outlook and Recommendations or Action.md  # Outlook and Recommendations for Action
│   ├── 08 Annex 1 Detailed Implementation and Evaluation Structure Reference Repository.md  # Appendix 1 Detailed Implementation and Evaluation Structure (Reference Repository)
│   ├── 09 Annex 2 Research Results.md  # Appendix 2 Research Results
...
│   ├── README.md                 # Haupteinstiegsseite (Überblick, Navigation)
│   ├── 01 Einleitung.md          # Einleitung
│   ├── 02 Fortschritte und Entwicklungen 2024,2025.md  # Fortschritte und Entwicklungen 2024,2025
│   ├── 03 Geopolitische Randbedingungen für industrielle Anwender.md  # Geopolitische Randbedingungen für industrielle Anwender
│   ├── 04 Industrie 40 Kontext.md  # Industrie 4.0 Kontext
│   ├── 05 Informationen zum AI-Act der EU.md  # Informationen zum AI-Act der EU
│   ├── 06 Durchführung und Ergebnisse eines Proof of Concept für ausgewählte Use Cases.md  # Durchführung und Ergebnisse eines Proof of Concept für ausgewählte Use Cases
│   ├── 07 Ausblick und Handlungsempfehlungen .md  # Ausblick und Handlungsempfehlungen
│   ├── 08 Anhang 1 Detaillierte Umsetzungs- und Evaluierungsstruktur (Referenz-Repository).md  # Anhang 1 Detaillierte Umsetzungs- und Evaluierungsstruktur (Referenz-Repository)
│   ├── 09 Anhang 2 Forschungsergebnisse.md  # Anhang 2 Forschungsergebnisse
│   ├── 10 Verweise.md            # Verweise
│   ├── 11 Glossar.md             # Glossar
│   ├── apx/                      # Anhang / Anlagen
│   │   ├── README.md             # Anhang-Übersicht
│   │   ├── Anhang 1/             # Anhang 1
│   │   │   ├── Data-_und_AI-Governance.md  # Data- und AI-Governance
│   │   │   ├── Modul_ZTA_Teil_1.md  # Modul ZTA Teil 1
│   │   │   ├── Modul_ZTA_Teil_2.md  # Modul ZTA Teil 2
│   │   │   ├── Modul_ZTA_Teil_3.md  # Modul ZTA Teil 3
│   │   │   ├── Policy.md         # Policy
│   │   │   ├── README.md         # Readme
│   │   │   ├── SoA.md            # State of the Art
│   │   │   ├── html/             # HTML-Ausgaben
